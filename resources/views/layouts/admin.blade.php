...
<html>
  ...
  <meta name="csrf-token" content="{{ csrf_token() }}" />
    ...
    <title>PPE Sistema de Ventas</title>
    ...
    <div class="wrapper">
      <header class="main-header">
        ...
        <a href={{'/ventas/venta'}} class="logo">
          ...
          <span class="logo-mini"><b><img src="{{asset('imagenes/logo_ppe2.png')}}"></b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b><img src="{{asset('imagenes/logo_ppe2.png')}}">   PPE LTDA   </b></span>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      PPE LTDA Logistica para su empresa
                      <small></small>
                    </p>
                  </li>
